...
#check if the does not exceed 5, check if the sum is at least 1, check if both components are positive
permittedAcceleration = np.dstack([velocityFeatures[:,:,0] < 6, velocityFeatures[:,:,0] > 0, velocityFeatures[:,:,1] > -1])
